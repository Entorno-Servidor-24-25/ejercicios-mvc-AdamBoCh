...
index.php->userController.php->userForm.php
El usuario accede a index.php el cual llama al controlador userController.php que llamara al metodo showForm que nos mostrara el userForm.php.
...
userForm.php->saveUser.php->userController.php->User.php

userForm.php envia los datos a saveUser.php, el cual llama al controlador UserController.php al que luego utiliza el modelo User.php para guardar los datos en la base de datos.
